...
# image.data.comb <- read.csv("image_data_comb_20220208.csv")
...
#   
#     ggsave(paste0("new_figures/rankings_plots/", i, ".png"), height = 12, width = 12, units = "in")
#   
# }
